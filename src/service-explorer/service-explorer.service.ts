...
import {
  getInstanceMetadataValue,
  instanceHasMetadata,
} from "../mixins/helpers/metadata";
...
export class ServiceExplorerService {
  ...
  public filterProviders(
    filter: (service: InstanceWrapper) => boolean
  ): InstanceWrapper[] {
   ...
   */
  public filterWithInstances<T = any>(
    filter: (service: unknown) => boolean
  ): T[] {
   ...
   */
  public filterByMetadata<T = any, R = any>(
   ...
   */
  public filterByMetadataValue<T = any, R = any>(
    metadataKey: string | symbol,
    metadataValue: T
  ): R[] {
