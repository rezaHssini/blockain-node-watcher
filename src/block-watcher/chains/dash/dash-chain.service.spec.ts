...
import { DashChainService } from "./dash-chain.service";

describe("DashChainService", () => {
  let service: DashChainService;
  beforeEach(async () => {
    jest.clearAllTimers();
    ...
    service = module.get<DashChainService>(DashChainService);
  });
